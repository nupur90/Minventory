...
scotchApp.controller('stockReconciliationController', function ($rootScope, $scope, $http, $location, $routeParams, $filter) {
    ...
    $scope.StockReconciliation = function () {
        ...
        $http.get('http://localhost:3200/api/View_StockReconciliations')
                   .success(function (res)
                   {
                       ...
                       for (var i = 0; i < count; i++) {
                           ...
                           $http.get('http://localhost:3200/api/SP_Stock_Reconcilation/' + id + '?startdate=' + startdate + '&enddate=' + enddate)
                                           .success(function (res) {
