...
scotchApp.controller('expenseReportController', function ($rootScope, $scope, $http, $location, $routeParams, $filter) {
    ...
    $scope.ShowRecords = function () {
        ...
        // alert(startDate);
        // alert(endDate);
        //http://localhost:3200/api/SP_ExpensesReport?startdate=2015-12-01&enddate=2016-1-31
        $http.get('http://localhost:3200/api/SP_ExpensesReport?startdate=' + startDate + '&enddate=' + endDate)
